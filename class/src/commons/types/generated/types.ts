...
export type IMutation = { //mutation 관련된 api 목록들 중에서 필요한 것만 pick해서 가져오면 된다. //<Pick<IMutation,'createBoard'>>
  __typename?: 'Mutation';
...
export type IMutationCreateBoardArgs = { //createboard에 사용되는 argument //useMutation<Pick<IMutation,'createBoard'>,IMutationCreateBoardArgs >
