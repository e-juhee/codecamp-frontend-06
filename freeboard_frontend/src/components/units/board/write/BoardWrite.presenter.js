        ...
        <Title>게시물 등록</Title>
            ...
            <WriterWrapper>
                <InputWrapper>
                    ...
                    <ShortInput {...props.register("writer", { required: true })}   type="text" placeholder="이름을 적어주세요."/>
                    {props.errors.writer && <Error>이름을 입력해주세요.</Error>}
                </InputWrapper>

                <InputWrapper>
                    <Label>비밀번호<Required>*</Required></Label>
                    <ShortInput {...props.register("password", { required: true })}  type="password" placeholder="비밀번호를 입력해주세요."/>
            ...
            <InputWrapper>
                ...
                <Input {...props.register("title", { required: true })}   type="text" placeholder="제목을 작성해주세요."/>
                {props.errors.title && <Error>제목을 입력해주세요.</Error>}
                <Label>내용<Required>*</Required></Label>
                <ContentInput {...props.register("contents", { required: true })}  type="text" placeholder="내용을 작성해주세요."/>
