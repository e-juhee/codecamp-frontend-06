...
import { ICommentWriteUIProps } from "./ProductQuestionWrite.types";
import * as S from "./ProductQuestionWrite.style";

export default function ProductQuestionWriteUI(props: ICommentWriteUIProps) {
  return (
    <>
      <S.CWrapper>
        {props.isEdit || (
